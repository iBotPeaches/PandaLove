...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Used for forcing download of ALL profile data. Useful when historic
    ...
    */
    ...
    'providers' => [
         ...
         */
        'PandaLove\Providers\AppServiceProvider',
        'PandaLove\Providers\BusServiceProvider',
