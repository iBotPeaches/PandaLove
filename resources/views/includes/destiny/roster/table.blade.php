                ...
                <tr>
                    ...
                    <td>
                        <span class="right floated author">
                            ...
                            <a href="{{ URL::action('ProfileController@index', [$member->seo, $member->destiny->characterAtPosition(1)->characterId]) }}">
                    ...
                    <td>
                        <span class="right floated author">
                            ...
                            <a href="{{ URL::action('ProfileController@index', [$member->seo, $member->destiny->characterAtPosition(2)->characterId]) }}">
                    ...
                    <td>
                        <span class="right floated author">
                            ...
                            <a href="{{ URL::action('ProfileController@index', [$member->seo, $member->destiny->characterAtPosition(3)->characterId]) }}">
