    ...
    <tbody>
        @foreach($members as $member)
            @if ($member->destiny->charactersCount() >= 3 && $member->destiny->characterAtPosition(1)->level == \Onyx\Destiny\Enums\LightLevels::$MAX_LEVEL)
                <tr>
                    <td><a href="{{ URL::action('Destiny\ProfileController@index', [$member->accountType, $member->seo]) }}">{{ $member->gamertag }}</a></td>
                    ...
                    <td>
                        <span class="right floated author">
                            ...
                            <a href="{{ URL::action('Destiny\ProfileController@index', [$member->accountType, $member->seo, $member->destiny->characterAtPosition(1)->characterId]) }}">
                    ...
                    <td>
                        <span class="right floated author">
                            ...
                            <a href="{{ URL::action('Destiny\ProfileController@index', [$member->accountType, $member->seo, $member->destiny->characterAtPosition(2)->characterId]) }}">
                    ...
                    <td>
                        <span class="right floated author">
                            ...
                            <a href="{{ URL::action('Destiny\ProfileController@index', [$member->accountType, $member->seo, $member->destiny->characterAtPosition(3)->characterId]) }}">
